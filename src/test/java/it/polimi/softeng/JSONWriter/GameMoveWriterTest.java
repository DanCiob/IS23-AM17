...
class GameMoveWriterTest {
    ...
    void writeGameMoveTest() throws IOException, IllegalInsertException {
        ...
        JSONGameMoveTest1.write(clientSignObject(writeGameMove("(0,1 ),3 "), "@GAME", "requester").toJSONString());
        JSONGameMoveTest2.write(clientSignObject(writeGameMove("(0,1),(2,4),2"), "@GAME", "requester").toJSONString());
        JSONGameMoveTest3.write(clientSignObject(writeGameMove("(0,1),(2,4),(6,3),2"), "@GAME", "requester").toJSONString());
        JSONGameMoveTest4.write(clientSignObject(writeGameMove("(0,5 ),3 "), "@GAME", "requester").toJSONString());
        JSONGameMoveTest5.write(clientSignObject(writeGameMove("(4,2),(3,1),0"), "@GAME", "requester").toJSONString());
        JSONGameMoveTest6.write(clientSignObject(writeGameMove("(1,2),(2,4),(5,3),1"), "@GAME", "requester").toJSONString());
